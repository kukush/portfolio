const config = {
  hero: {
    ...
    bio:
      ...
      "Software Architect with 10+ years of experience building scalable digital systems across Ethiopia and Europe. Focused on innovation, reliable technology, and creating impactful solutions for Africa.",
    keywords: ["Cloud Architecture", "Product Engineering", "Startup Innovation", "AI || MCP", "IIOT"],
    status: {
  ...
  experience: [
    ...
    },
    {
      ...
      highlights: ["Full-stack role, backend, API and frontend.", "Design and develop a multi-level java web application."],
    },
    {
  ...
  projects: [
    {
      name: "Financial & telecom asset management application",
      description:
      ...
      technologies: ["Next.js", "Node.js", "React", "RoomDatabase", "TypeScript"],
      demoLink: "https://github.com/kukush/EthioStat-V-4",
      featured: true,
    },
    {
