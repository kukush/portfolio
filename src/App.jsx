  ...
  return (
    <div className='container'>
      ...
      <section id='experience' className='experience'>
        ...
        {experience.length > 3 && (
          <button type='button' className='show-more-button' onClick={() => setShowAllExperience(!showAllExperience)}>
      ...
      <section id='projects' className='projects'>
        ...
        <p className='section-description'>A selection of projects that demonstrate my expertise in full-stack development and modern devlopment practices.</p>
      ...
      <section id='contact' className='contact'>
        ...
        <div className='contact-content'>
          <p className='contact-intro'>I'm always interested in hearing about new opportunities and exciting projects. Whether you have a question or just want to say hi, feel free to reach out!</p>
